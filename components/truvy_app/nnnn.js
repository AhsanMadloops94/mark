...
function Nuitrition({navigation}) {
  ...
  const [iconcolor9, setIconcolor9] = useState('lightgrey');
  const [iconcolor10, setIconcolor10] = useState('lightgrey');
  const [iconcolor11, setIconcolor11] = useState('lightgrey');
  const [iconcolor12, setIconcolor12] = useState('lightgrey');
  const [iconcolor13, setIconcolor13] = useState('lightgrey');
  const [iconcolor14, setIconcolor14] = useState('lightgrey');
  const [iconcolor15, setIconcolor15] = useState('lightgrey');
  const [iconcolor16, setIconcolor16] = useState('lightgrey');
